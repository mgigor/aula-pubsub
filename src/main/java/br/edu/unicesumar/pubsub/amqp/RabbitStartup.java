...
public class RabbitStartup {
    ...
    // TopicExchange topicExchangeTeste = new TopicExchange("topic-exchange-teste",
    // true, false);

    // Binding bindingFilaLogInfo = new Binding(filaLogInfo.getName(),
    // DestinationType.QUEUE, topicExchangeTeste.getName(), "#.info", null);
    // Binding bindingFilaLogWarn = new Binding(filaLogWarn.getName(),
    // DestinationType.QUEUE, topicExchangeTeste.getName(), "#.warn", null);
    // Binding bindingFilaLogError = new Binding(filaLogError.getName(),
    // DestinationType.QUEUE, topicExchangeTeste.getName(), "#.error", null);
    // Binding bindingFilaLogGeral = new Binding(filaLog.getName(),
    // DestinationType.QUEUE, topicExchangeTeste.getName(), "log.*", null);
    ...
    // this.rabbitTemplate.convertAndSend(topicExchangeTeste.getName(), "info",
    // "message");
    ...
    // // DirectExchange directExchangeTeste = new
    // DirectExchange("direct-exchange-teste", true, false);
    // // Binding bindingTeste = new Binding(filaTeste.getName(),
    // DestinationType.QUEUE, directExchangeTeste.getName(), "igor.gorini", null);
    ...
    // // this.rabbitTemplate.convertAndSend(directExchangeTeste.getName(),
    // "igor.gorini2", "message");

    // //FanoutExchange fanoutExchangeTeste = new
    // FanoutExchange("fanout-exchange-teste", true, false);
    // //Binding bindingTeste = new Binding(filaTeste.getName(),
    // DestinationType.QUEUE, fanoutExchangeTeste.getName(), "", null);
    // //this.amqpAdmin.declareQueue(filaTeste);
    // //this.amqpAdmin.declareExchange(fanoutExchangeTeste);
    // //this.amqpAdmin.declareBinding(bindingTeste);

    // //this.rabbitTemplate.convertAndSend(fanoutExchangeTeste.getName(), "",
    // "message");
